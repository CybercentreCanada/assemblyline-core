...
class KubernetesController(ControllerInterface):
    ...
    def start_stateful_container(self, service_name: str, container_name: str,
        ...
        try:
            ...
            service.spec.ports = [V1ServicePort(port=int(_p), name=f"port_{_p}") for _p in spec.container.ports]
            ...
            service = V1Service(
                ...
                spec=V1ServiceSpec(
                    cluster_ip='None',
                    selector=labels,
                    ports=[V1ServicePort(port=int(_p), name=f"port_{_p}") for _p in spec.container.ports]
                )
            )
